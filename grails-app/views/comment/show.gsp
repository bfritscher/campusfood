            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.meal.label" default="Meal" /></td>
                            
                            <td valign="top" class="value"><g:link controller="meal" action="show" id="${commentInstance?.meal?.id}">${commentInstance?.meal?.encodeAsHTML()}</g:link></td>
