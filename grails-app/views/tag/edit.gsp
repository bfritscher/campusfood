...
<%@ page import="ch.fritscher.campusfood.Tag" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="meals"><g:message code="tag.meals.label" default="Meals" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tagInstance, field: 'meals', 'errors')}">
